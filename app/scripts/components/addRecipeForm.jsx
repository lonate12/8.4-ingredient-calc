    ...
    return(
      <form onSubmit={this.handleSubmit} className="col-md-6 col-md-offset-3">
        ...
        <div className="form-group">
          ...
          <input onChange={this.handleInputChange} type="text" className="form-control" name="creator" id="owner" placeholder="By" value={this.state.creator} />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input onChange={this.handleInputChange} type="text" className="form-control" id="prep_time" name="prep_time" placeholder="Prep Time in minutes (i.e. 30)" value={this.state.prep_time} />
          <label htmlFor="cook_time">Cook Time (in min)</label>
          <input onChange={this.handleInputChange} type="text" className="form-control" id="cook_time" name="cook_time" placeholder="Cook Time in minutes (i.e. 30)" value={this.state.cook_time}/>
          <label htmlFor="cook_temp">Cook Temp (in Farenheit)</label>
          <input onChange={this.handleInputChange} type="text" className="form-control" id="cook_temp" name="cook_temp" placeholder="Cook Temp in Farenheit (i.e. 350)" value={this.state.cook_temp}/>
        </div>
        <div className="form-group form-inline">
          <span>This recipe will make </span>
          <label className="sr-only" htmlFor="quantity">Serving Amount</label>
          <input onChange={this.handleInputChange} type="text" className="form-control" id="quantity" name="quantity" placeholder="Amount" value={this.state.quantity}/>
...
var AddRecipeFormContainer = React.createClass({
  ...
  render: function(){
    ...
    return(
      <Template>
        <div className="row">
          <AddRecipeForm isVisible={this.state.isVisible} recipe={this.state.recipe}/>
        </div>
